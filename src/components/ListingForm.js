...
const ListingForm = (props) => {
  ...
  const onSubmit = e => {
    ...
    {
    sale_type, price, bedrooms, home_type, 
    bathrooms, sqft, days_listed, has_photos, keywords 
    })
    .then(res => {
      setLoading(false);
      ...
      <div className='row'>
        ...
        <div className='col-1-of-6'>
          ...
          <div className='listingform__section'>
            ...
            <select className='listingform__select' name='has_photos' onChange={(e) => onChange(e)} value={days_listed}>
              <option>1+</option>
              <option>3+</option>
              <option>5+</option>
              <option>10+</option>
        ...
        <div className='col-1-of-6'>
          {
            ...
            <div className='listingform__loader'> 
              <Loader 
                ...
                width={50}
              /> 
            </div> : <button className='listingform__button listingform__button--primary'>Search</button>  
          }
        </div>
      </div>
    </form>
